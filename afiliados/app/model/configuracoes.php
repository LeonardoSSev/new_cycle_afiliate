...
class Configuracoes{
	...
	public function editarconfig19($pdo,$valor1,$upgrade1,$lateralidade1,$sustentabilidade1,$reentrada1,$id){
	...
	public function editarconfig20($pdo,$valor1,$upgrade1,$lateralidade1,$sustentabilidade1,$reentrada1,$id){
	...
	public function editarconfig18($pdo,$habilitar18,$id){

		$sql = "UPDATE configuracoes SET habilitar = :habilitar WHERE id = :id";
		$obj = $pdo->prepare($sql);
		$obj->bindParam(":habilitar",$habilitar18);
		$obj->bindParam(":id",$id);
		$obj->execute();
	...
	public function ok($pdo, $userid){
		
		$sql = "UPDATE acesso SET termos = '1' WHERE userid = :userid";
		$obj = $pdo->prepare($sql);
		$obj->bindParam(":userid",$userid);
		$obj->execute();
