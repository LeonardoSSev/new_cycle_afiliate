...
<head>
		...
		<!-- Title -->
<title>Sistema CDEA New Cycle - Esqueceu Senha</title>
<!--Favicon -->
							...
							<div class="row justify-content-center">
									...
									<div class="card-group mb-0">
										<div class="card p-4">
											<div class="card-body">
												...
												<p class="text-muted">Digite seu usuário e email</p>
								...
								<div id="recaptcha" class="recaptcha-identifier"></div>
												...
												<div class="row">
													...
													<div class="col-12">
														<a href="./" class="btn btn-link box-shadow-0 px-0">Voltar ao Login?</a>
													</div>
												</div>
												</form>
											</div>
    ...
    function renderReCaptcha() {
        ...
        if (captchas.length != 0){
            captchas.forEach(function (elem, index) {
                ...
                recaptcha = grecaptcha.render(captchaId, { 'sitekey' : '<?=$param['esqueceu']['sitekey'];?>', 'theme' : 'light' });
