...
class App {
	...
	public $db_user = "cdeanewc_ycle";
	public $db_pass = "Celrome$*#1069";
	public $db_name = "cdeanewc_ycle";

	// dados do site
	public $site_titulo = " Backoffice";
	...
	function uploadComprovanteUsuario($arquivo){
		...
		//if(array_search($ext,$this->ext_img) === 0) {
			if(move_uploaded_file($arquivo['tmp_name'], $img_tmp)){
				...
				include("libs/wideimage/WideImage.php");
				WideImage::load($img_tmp)->saveToFile($this->sistema_pasta_comprovantes.$foto);
