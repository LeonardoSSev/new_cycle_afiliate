<?php
    ...
    Class Ciclos{
        ...
        public function Upgrade($pdo, $ciclo, $idpagamento){
            ...
            $objc0->execute();
            $linhac = $objc0->fetch(PDO::FETCH_ASSOC);
            $cupom = $linhac['cupom'];$cupom2 = $linhac['cupomb'];$idusuario = $linhac['userid'];
            ...
            if($contagem < $lateralidade){
                ...
                $sqle = "INSERT INTO pagamentos (userid,cupom,cupomb,useridb,valor,fase,posicao,ativacao,datavencimento,registro) VALUES (:userid,:cupom,:cupomb,:useridb,:valor,:fase,'0','0',:datavencimento,'".$datas."')";
                $obje = $pdo->prepare($sqle);
                $obje->bindParam(":userid",$idusuario);
                $obje->bindParam(":cupom",$cupom);
                $obje->bindParam(":cupomb",$cupomb);
        ...
        public function Retorno($pdo,$idpagamento){
            ...
            if($pa == '1'){
                ...
                $sql1 = "UPDATE pagamentos SET ativacao='0' WHERE cupom = :cupomp AND ativacao = '4'";
                $obj1 = $pdo->prepare($sql1);
                $obj1->bindParam(":cupomp",$cupom);
                $obj1->execute();
            ...
            if($fase > '1'){
                    // valor de ugprade
                $sqld1 = "UPDATE indicados SET ativacao='1',fase = :fasec,dataativacao = :dataativab WHERE cupom = :cupomc ";
            ...
            $sqld = "SELECT * FROM pagamentos WHERE fase = :faseb AND ativacao='1' AND cupomb = :cupomb";
            $objd = $pdo->prepare($sqld);
            ...
            $sqld2 = "SELECT * FROM pagamentos WHERE userid = :useridb AND ativacao='0' ";
            ...
            $obje->bindParam(":logins",$contagem1);
