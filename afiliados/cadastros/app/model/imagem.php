...
class Imagem {
	...
	public function pegaComprovantesPendentes($app,$userid){
		...
		$sql = "SELECT *,acesso.usuario,dadospessoais.nome FROM comprovantes,acesso,dadospessoais WHERE comprovantes.userid = acesso.userid AND acesso.userid = dadospessoais.userid AND comprovantes.ativacao='0' AND comprovantes.userid = :userid  order by comprovantes.id DESC";
		$obj = $app->prepare($sql);
		$obj->bindParam(":userid",$userid);
		$obj->execute();
		return $obj;
	...
	public function pegaComprovantesAprovados($app,$userid){
		...
		$sql = "SELECT *,acesso.usuario,dadospessoais.nome FROM comprovantes,acesso,dadospessoais WHERE comprovantes.userid = acesso.userid AND acesso.userid = dadospessoais.userid AND comprovantes.ativacao='1' AND comprovantes.userid = :userid  order by comprovantes.id DESC";
		$obj = $app->prepare($sql);
		$obj->bindParam(":userid",$userid);
		$obj->execute();
		return $obj;
	...
	public function pegaDoacoesRecebidas($app,$userid){
		...
		$sql = "SELECT *,acesso.usuario,dadospessoais.nome FROM pagamentos,acesso,dadospessoais WHERE pagamentos.userid = acesso.userid AND acesso.userid = dadospessoais.userid AND pagamentos.ativacao='1' AND pagamentos.useridb = :userid  order by pagamentos.id DESC";
		$obj = $app->prepare($sql);
		$obj->bindParam(":userid",$userid);
		$obj->execute();
		return $obj;
	...
	public function pegaDoacoesFeitas($app,$userid){
		...
		$sql = "SELECT *,acesso.usuario,dadospessoais.nome FROM pagamentos,acesso,dadospessoais WHERE pagamentos.userid = acesso.userid AND acesso.userid = dadospessoais.userid AND pagamentos.ativacao='1' AND pagamentos.userid = :userid  order by pagamentos.id DESC";
		$obj = $app->prepare($sql);
		$obj->bindParam(":userid",$userid);
		$obj->execute();
		return $obj;
	...
	public function pegaComprovantes($app, $userid, $id){
		...
		$sql = "SELECT * FROM comprovantes where userid = :userid AND idfatura = :id order by id DESC limit 0,1";
	...
	public function pegaAdmComprovantes($app,  $id){
		...
		$sql = "SELECT * FROM comprovantes where  idfatura = :id order by id DESC limit 0,1";
	...
	public function mandarComprovante($app,$userid, $img, $id){
		...
		$sql = "insert into comprovantes(userid,imagem,idfatura,registro) VALUES (:userid, :img, :id,'".$datas."')";
